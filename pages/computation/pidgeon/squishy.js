...
function touchStarted(){
  ...
  return false;//prevent default browser behavior, this is my recent line of change!!! untested
}
...
function draw() {
  ...
  if (mouseIsPressed && (whichParticleIsGrabbed > -1)) {// If the user is grabbing a particle, peg it to the mouse.
...
//from 104 spring systems lecture
//==========================================================
